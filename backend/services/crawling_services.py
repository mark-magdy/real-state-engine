...
class CrawlingService:
    ...
    def crawl_data(self):
        """Main method to crawl data from all sources."""
        df_pf_new  = self.scrape_pf_new_projects(limit=10)
        df_pf_buy  = self.scrape_pf_listings(category_id=1, listing_type_label="buy", limit=10)
        df_pf_rent = self.scrape_pf_listings(category_id=2, listing_type_label="rent", limit=10)
        df_nawy    = self.scrape_nawy(limit=10)
    ...
    # ============================================================
    def scrape_pf_new_projects(self, limit=1000):
        print("\n" + "="*60)
    ...
    def scrape_pf_listings(self, category_id, listing_type_label, limit=1000):
        print(f"\n{'='*60}")
    ...
    def scrape_nawy(self, limit=1000):
        print("\n" + "="*60)
